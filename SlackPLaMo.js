...
const plamoApiHost = PropertiesService.getScriptProperties().getProperty("PLAMO_API_HOST"); // https://platform.preferredai.jp
const plamoApiKey = PropertiesService.getScriptProperties().getProperty("PLAMO_API_KEY"); // NjZ...XJV
const plamoModel = PropertiesService.getScriptProperties().getProperty("PLAMO_MODEL"); // plamo-beta
// PLaMoのエンドポイントを設定する
const ENDPOINT = plamoApiHost + "/api/completion/v1/chat/completions" ;
